...
<head>
  ...
  <!-- Fav and touch icons -->
  <link rel="shortcut icon" href="${contextPath}/resources/img/icons/favicon.png">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <ul class="list-inline user-menu pull-right">
                <li class="hidden-xs"><i class="fa fa-edit text-primary"></i> <a href="registeration" class="text-uppercase">Register</a></li>
            ...
            <ul class="nav navbar-nav" id="main-menu">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="registeration" tabindex="-1" class="menu-item">Sign-Up</a></li>
