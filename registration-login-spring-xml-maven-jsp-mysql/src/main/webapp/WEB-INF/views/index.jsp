...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="${contextPath}/resources/img/icons/114x114.png">
  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="${contextPath}/resources/img/icons/72x72.png">
  <link rel="apple-touch-icon-precomposed" href="${contextPath}/resources/img/icons/default.png">
  ...
  <link href="${contextPath}/resources/lib/owlcarousel/owl.carousel.min.css" rel="stylesheet">
  <link href="${contextPath}/resources/lib/owlcarousel/owl.theme.min.css" rel="stylesheet">
  <link href="${contextPath}/resources/lib/owlcarousel/owl.transitions.min.css" rel="stylesheet">
          ...
          <div class="row">
            <div class="col-md-8">
              ...
              <a class="navbar-brand" href="index" title="Home">
                <h1 class="hidden">
                    <img src="${contextPath}/resources/img/logo.png" alt="Flexor Logo">
                    Flexor
                  </h1>
              </a>
            ...
            <div class="col-md-4">
              ...
              <ul class="list-inline user-menu pull-right">
                <li class="hidden-xs"><i class="fa fa-edit text-primary"></i> <a href="register" class="text-uppercase">Register</a></li>
                <li class="hidden-xs"><i class="fa fa-sign-in text-primary"></i> <a href="login" class="text-uppercase">Logout</a></li>
      ...
      <div class="container">
        <div class="navbar navbar-default">
          ...
          <div class="navbar-text social-media social-media-inline pull-right">
            ...
            <a href="login"><i class="fa fa-twitter"></i></a>
            <a href="login"><i class="fa fa-facebook"></i></a>
            <a href="login"><i class="fa fa-linkedin"></i></a>
            ...
            <ul class="nav navbar-nav" id="main-menu">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="elements" tabindex="-1" class="menu-item">Elements</a></li>
                  <li><a href="about" tabindex="-1" class="menu-item">About / Inner Page</a></li>
                  <li><a href="login" tabindex="-1" class="menu-item">Login</a></li>
                  <li><a href="registration" tabindex="-1" class="menu-item">Sign-Up</a></li>
                  <li class="dropdown-footer">Dropdown footer</li>
                </ul>
              </li>
              <li><a href="elements">PRODUCTS</a></li>
                ...
                <ul class="dropdown-menu dropdown-menu-mm dropdown-menu-persist">
                  <li class="row">
                    <ul class="col-md-6">
                      ...
                      <li><a href="about">Analysis and Planning</a></li>
                      <li><a href="about">User Experience / Information Architecture</a></li>
                      <li><a href="about">User Interface Design / UI Design</a></li>
                      <li><a href="about">Code &amp; Development / Implementation &amp; Support</a></li>
                    </ul>
                    <ul class="col-md-6">
                      <li class="dropdown-header">Enterprise solutions</li>
                      <li><a href="about">Business Analysis</a></li>
                      <li><a href="about">Custom UX Consulting</a></li>
                      <li><a href="about">Quality Assurance</a></li>
                    </ul>
                  </li>
            ...
            <div class="item">
              <div class="row">
                ...
                <div class="col-md-6 col-md-pull-6 hidden-xs">
                  <img src="${contextPath}/resources/img/slides/slide1.png" alt="Slide 1" class="center-block img-responsive">
                </div>
              </div>
            </div>
            <!--Slide 2-->
            <div class="item">
              <div class="row">
                ...
                <div class="col-md-6 hidden-xs">
                  <img src="${contextPath}/resources/img/slides/slide2.png" alt="Slide 2" class="center-block img-responsive">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="item-carousel" data-toggle="owlcarousel" data-owlcarousel-settings='{"items":4, "pagination":false, "navigation":true, "itemsScaleUp":true}'>
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project1.png" alt="Project 1 image" class="img-responsive underlay">
                <span class="overlay">
            ...
            <div class="item-details bg-noise">
              ...
              <a href="elements" class="btn btn-more"><i class="fa fa-plus"></i>Read more</a>
            </div>
          </div>
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project2.png" alt="Project 2 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project3.png" alt="Project 3 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project4.png" alt="Project 4 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project5.png" alt="Project 5 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project6.png" alt="Project 6 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project7.png" alt="Project 7 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project8.png" alt="Project 8 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project9.png" alt="Project 9 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project10.png" alt="Project 10 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project11.png" alt="Project 11 image" class="img-responsive underlay">
                <span class="overlay">
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
                <img src="${contextPath}/resources/img/showcase/project12.png" alt="Project 12 image" class="img-responsive underlay">
                <span class="overlay">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4 text-center">
            ...
            <p>
              <a href="about" class="btn btn-more i-right">Learn More <i class="fa fa-angle-right"></i></a>
            </p>
          </div>
          <div class="col-md-4 text-center">
            <span class="fa-stack fa-5x">
...
-->
    <div class="block block-pd-sm block-bg-grey-dark block-bg-overlay block-bg-overlay-6 text-center" data-block-bg-img="https://picjumbo.imgix.net/HNCK1088.jpg?q=40&amp;w=1650&amp;sharp=30" data-stellar-background-ratio="0.3">
      ...
      <p>
        <a href="login" class="btn btn-more btn-lg i-right">Join them today! <i class="fa fa-angle-right"></i></a>
      </p>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6 m-b-lg">
          ...
          <blockquote>
            ...
            <img src="${contextPath}/resources/img/misc/charles-quote.png" alt="Charles Spencer Chaplin">
            <small>
          ...
          <div class="row">
            ...
            <div class="col-xs-6 col-md-2">
              <a href="https://bootstrapmade.com" title="Client 1">
                  <img src="${contextPath}/resources/img/clients/client1.png" alt="Client 1 logo" class="img-responsive">
                </a>
            </div>
            <div class="col-xs-6 col-md-2">
              <a href="https://bootstrapmade.com" title="Client 2">
                  <img src="${contextPath}/resources/img/clients/client2.png" alt="Client 2 logo" class="img-responsive">
                </a>
            </div>
            <div class="col-xs-6 col-md-2">
              <a href="https://bootstrapmade.com" title="Client 3">
                  <img src="${contextPath}/resources/img/clients/client3.png" alt="Client 3 logo" class="img-responsive">
                </a>
            </div>
            <div class="col-xs-6 col-md-2">
              <a href="https://bootstrapmade.com" title="Client 4">
                  <img src="${contextPath}/resources/img/clients/client4.png" alt="Client 4 logo" class="img-responsive">
                </a>
            </div>
            <div class="col-xs-6 col-md-2">
              <a href="https://bootstrapmade.com" title="Client 5">
                  <img src="${contextPath}/resources/img/clients/client5.png" alt="Client 5 logo" class="img-responsive">
                </a>
            </div>
            <div class="col-xs-6 col-md-2">
              <a href="https://bootstrapmade.com" title="Client 6">
                  <img src="${contextPath}/resources/img/clients/client6.png" alt="Client 6 logo" class="img-responsive">
                </a>
            </div>
          </div>
        </div>
  ...
  <script src="${contextPath}/resources/lib/stellar/stellar.min.js"></script>
  ...
  <script src="${contextPath}/resources/js/color-switcher.js"></script>
