          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <ul class="list-inline user-menu pull-right">
                <li class="hidden-xs"><i class="fa fa-edit text-primary"></i> <a href="registration" class="text-uppercase">Register</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-9 col-md-push-3">
          ...
          <div class="block block-border-bottom-grey block-pd-sm">
            ...
            <img src="${contextPath}/resources/img/misc/about-us.png" alt="About us" class="img-responsive img-thumbnail pull-right m-l m-b">
